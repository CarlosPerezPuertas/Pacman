...
{
	sf::FloatRect rect = sf::FloatRect(tmx_info.collision_map[pos].rect.left + tmx_info.collision_map[pos].rect.width/2.f - 1,
									   tmx_info.collision_map[pos].rect.top + tmx_info.collision_map[pos].rect.height/2.f - 1, 
									   2.f, 
									   2.f);
	return rect;
}
